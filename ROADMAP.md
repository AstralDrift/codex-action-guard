...
- First `v0.1.0` release with Linux, macOS, and Windows CLI artifacts.
- Floating `v0` action tag for compatible v0 usage.
- First-class `install` command for safe guard workflow adoption.
